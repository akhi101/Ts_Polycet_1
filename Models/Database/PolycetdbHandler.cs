    ...
    public class PolycetdbHandler
    {
        ...
        public string GetConnectionString()
        {
            try
            {
                ...
                string ConnString = "Data Source=" + appSettings["PolycetDBServerName"] + ";Initial Catalog=" + appSettings["PolcetDatabaseName"] + ";User ID=" + ConfigurationManager.AppSettings["PolycetDbUserName"].ToString() + "; Password=" + ConfigurationManager.AppSettings["PolycetDbUserPassword"].ToString() + ";Max Pool Size=5000";
        ...
        public static void SaveErorr(string ClassName, int UpdLoginID, string Erorr)
        {
            try
            {
                ...
                PolycetdbHandler.ExecuteNonQueryWithStoredProcedure("USP_SET_ErrorLog", param);
            }
            catch (Exception ex)
            {
