define(['app'], function (app) {
    app.controller("PaymentResponseController", function ($scope, $http, $localStorage, $state, $stateParams, $interval, AppSettings, PaymentService) {
        $scope.success = false;
        ...
        $scope.back = function () {
            if ($localStorage.CertificateFeePaymentGatewayResponse.redirecturl != null && $localStorage.CertificateFeePaymentGatewayResponse.redirecturl != undefined) {
                ...
                $state.go('index.PaymentResponse');
